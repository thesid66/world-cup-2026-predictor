...
function buildPlayerImpact(rows: CountryMatchRow[], expectedGoals: number, expectedYellowCards: number, expectedRedCards: number) {
  ...
  if (expectedGoals > assignedGoals) getPlayer('Unattributed team goals').goals = expectedGoals - assignedGoals
  if (expectedYellowCards > assignedYellowCards) getPlayer('Unattributed team cards').yellowCards = expectedYellowCards - assignedYellowCards
  if (expectedRedCards > assignedRedCards) getPlayer('Unattributed team red cards').redCards = expectedRedCards - assignedRedCards
